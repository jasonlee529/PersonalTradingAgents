...
ANALYST_NODE_SPECS: Dict[str, AnalystNodeSpec] = {
    ...
    "catalyst": AnalystNodeSpec(
        key="catalyst",
        agent_node="Catalyst Mapper",
        clear_node="Msg Clear Catalyst",
        tool_node="tools_catalyst",
        report_key="catalyst_report",
    ),
    "flow_risk": AnalystNodeSpec(
        key="flow_risk",
        agent_node="Flow Risk Analyst",
        clear_node="Msg Clear Flow Risk",
        tool_node="tools_flow_risk",
        report_key="flow_risk_report",
    ),
}
